...
<div class="col-3 p-0 col-sm-3 col-md-5 col-lg-6 align-self-center" id="div_formulario_login">

    <div class=" d-flex justify-content-start" id="div_btn_fechar">
    ...
    <form method="POST" style="width: 100%;" action="/auth" id="formulario_de_login">
        @csrf
        <input type="email" id="email_login" name="email" class="form-control justify-content-center border border-dark text-dark mb-2" aria-label="Small" aria-describedby="inputGroup-sizing-sm" placeholder="Email">
        ...
        <button type="button" id="logar" class="btn btn-dark btn-sm d-block" style="width: 100%;">Entrar</button>
        <a  id="link_recuperar_senha" href="/recuperar">Esqueceu sua senha ?</a>
    </form>
